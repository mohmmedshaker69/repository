...
namespace iti {
    ...
    public partial class companyDataSet : global::System.Data.DataSet {
        ...
        public partial class productDataTable : global::System.Data.TypedTableBase<productRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public productRow AddproductRow(string name, string code, decimal price, string notes, string image) {
...
namespace iti.companyDataSetTableAdapters {
    ...
    public partial class productTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[product] WHERE (([id] = @Original_id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_code = 1 AND [code] IS NULL) OR ([code] = @Original_code)) AND ((@IsNull_price = 1 AND [price] IS NULL) OR ([price] = @Original_price)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[product] ([name], [code], [price], [notes], [image]) VALUES (@" +
                "name, @code, @price, @notes, @image);\r\nSELECT id, name, code, price, notes, imag" +
                "e FROM product WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[product] SET [name] = @name, [code] = @code, [price] = @price, [notes] = @notes, [image] = @image WHERE (([id] = @Original_id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_code = 1 AND [code] IS NULL) OR ([code] = @Original_code)) AND ((@IsNull_price = 1 AND [price] IS NULL) OR ([price] = @Original_price)));
SELECT id, name, code, price, notes, image FROM product WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, name, code, price, notes, image FROM dbo.product";
        ...
        public virtual int Delete(int Original_id, string Original_name, string Original_code, global::System.Nullable<decimal> Original_price) {
        ...
        public virtual int Insert(string name, string code, global::System.Nullable<decimal> price, string notes, string image) {
            if ((name == null)) {
        ...
        public virtual int Update(string name, string code, global::System.Nullable<decimal> price, string notes, string image, int Original_id, string Original_name, string Original_code, global::System.Nullable<decimal> Original_price, int id) {
            if ((name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string code, global::System.Nullable<decimal> price, string notes, string image, int Original_id, string Original_name, string Original_code, global::System.Nullable<decimal> Original_price) {
            return this.Update(name, code, price, notes, image, Original_id, Original_name, Original_code, Original_price, Original_id);
        }
    }
